...
const AF = 'https://stream-cdn.masterotaku487.workers.dev'
    ...
    try {
      ...
      try {
        ...
        const ccRes = await fetch(
          `https://stream-cdn.masterotaku487.workers.dev/?action=episode&source=2` +
      ...
      try {
        ...
        const hdRes = await fetch(
          `https://stream-cdn.masterotaku487.workers.dev/?action=episode&source=3` +
              ...
              <div className="player-loading">
                ...
                <p className="loading-sub">
                  {status.includes('animesonlinecc') ? 'Fonte: 🌐 animesonlinecc.to'
                   : status.includes('source=3') ? 'Fonte: ☁️ CDN 3'
