...
const openMXPlayer = (url, title) => {
  ...
  // Formato correto: action=VIEW + type=video/* sao obrigatorios
  // Sem eles o Android nao reconhece o app e vai para Play Store
  ...
  // Tenta abrir — se o app nao existir Android redireciona para Play Store
  // Para evitar isso, usamos o scheme sem package especifico primeiro
  const intentGeneric = `intent:${url}#Intent;action=android.intent.action.VIEW;type=video/*;end`
